...
object CompilerAndPlugin_183 : BuildType({
    name = "IDEA Plugin Tests (183)"
    ...
    steps {
        ...
        gradle {
            name = "Plugin for IJ2018.3"
            tasks = "writePluginVersion ideaPlugin :ultimate:ideaUltimatePlugin"
            buildFile = "build.gradle.kts"
            gradleParams = "%gradleParameters% -PpluginVersion=%build.number%-IJ2018.3-%kotlin.plugin.patch.number% -x dist"
            jdkHome = "%projectJDK%"
        }
        gradle {
            name = "Plugin tests for IJ2018.3"
