...
object DeployMavenArtifacts_Bootstrap : BuildType({
    name = "Deploy Maven Artifacts (BOOTSTRAP)"
    description = "Automatically deploys build tagged with 'bootstrap' to bintray"
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """curl -D - -X PATCH --basic -u %system.kotlin.bintray.user%:%system.kotlin.bintray.password% https://api.bintray.com/packages/kotlin/kotlin-dev/kotlin/versions/%DeployVersion%/attributes -H 'Content-Type: application/json' -d '[{"name":"DeploymentKind","type":"string","values":["Bootstrap"]}]'"""
        }
    }
