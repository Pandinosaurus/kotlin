...
object BootstrapTest_progressive : BuildType({
    name = "Test Compiler Bootstrapping (Progressive mode)"
    ...
    params {
        ...
        param("system.test.progressive.mode", "true")
    }
